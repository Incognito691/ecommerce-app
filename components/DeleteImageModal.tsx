    ...
    <AlertDialog open={showDialog} onOpenChange={setShowDialog}>
      ...
      >
        <AlertDialogHeader className="space-y-2">
          ...
          >
            Are you sure you want to permanently delete this Image? This action
            cannot be undone and will remove the Image from your inventory.
          </AlertDialogDescription>
        </AlertDialogHeader>
        ...
        <div className="bg-red-50 dark:bg-red-950/20 p-4 rounded-lg border border-red-100 dark:border-red-900/50">
          <div className="flex items-center space-x-3">
            ...
            <p className="text-red-700 dark:text-red-300 text-sm">
              This will permanently delete the Image from all records.
            </p>
          </div>
        </div>
