...
const DeleteProductModal = (props: DeleteProductProps) => {
  ...
  const handleDeleteUpdate = async () => {
    setIsDeleting(true);
    try {
      await deleteProduct(props.product._id.toString()).unwrap();
      props.onSuccess();
      setShowDialog(false);
    } catch (error) {
        ...
        <div className="bg-red-50 dark:bg-red-950/20 p-4 rounded-lg border border-red-100 dark:border-red-900/50">
          <div className="flex items-center space-x-3">
            ...
            <p className="text-red-700 dark:text-red-300 text-sm">
              This will permanently delete the product from all records.
            </p>
          </div>
        </div>
